...
/**
 * handle_dot - This changes to the parent directory
 *
...
/**
 * handle_to_path - This will change to a directory given
 * by the user
 *
...
/**
 * handle_cd_back - This changes to the previous directory
 *
 * @shdata: data relevant (environ)
 * Return: no return
 */
...
/**
 * handle_cd_home - This changes to home directory
 *
 * @shdata: data relevant (environ)
 * Return: no return
 */
