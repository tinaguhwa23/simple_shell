...
/**
 * struct node_separator- single linked list
 * @separator: ; | &
 * @next: next node
 * Description: single linked list to store separators
 */
typedef struct node_separator
{
	char separator;
	struct node_separator *next;
} seperator_list;
...
/* mem.c */
void _memocpy(void *newptr, const void *ptr, unsigned int size);
