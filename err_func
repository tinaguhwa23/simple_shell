...
/**
 * error_get_cd - its an error message for cd command in get_cd
 * @shdata: data relevant (directory)
 * Return: Error message
 */
...
/**
 * error_not_found - Its a generic error message for command not found
...
/**
 * error_exit_shell - This is a generic error message for exit in get_exit
 * @shdata: data relevant (counter, arguments)
 *
 * Return: Error message
 */
