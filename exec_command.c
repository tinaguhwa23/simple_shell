...
/**
 * _which - This will locate a command
 *
 * @cmd: command name
...
/**
 * is_executable - This will determine if is an executable
 *
...
/**
 * check_cmd_error - This verifie if user has permissions to access
 *
...
/**
 * exec_cmd - This executes command lines
 *
